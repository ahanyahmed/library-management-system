...
public class AddBook extends javax.swing.JFrame implements Node{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(id.equals("")||title.equals("")||author.equals("")||publisher.equals("")||number.equals("")){
            ...
            for(int i = 0;i<lr.getListOfBooks().length;i++){
                if(lr.getListOfBooks()[i].getSearchKey().equals(id))
                isInside = true;
            }
            if(isInside)
            JOptionPane.showMessageDialog(null, "The Book with id = "+id+" already exists!");
            else{
                lr.addBook(id, title, author, publisher, quantity);
